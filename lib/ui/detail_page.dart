...
class DetailPage extends StatefulWidget {
  const DetailPage({this.onBackButtonPressed, this.transaction});
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              '${widget.transaction?.food?.name?.toInt() ?? ''}',
                    ...
                    Row(
                      children: [
                        ...
                        Icon(Icons.info_rounded, color: mainColor, size: 20),
                      ],
                    ),
                    Container(
